...
<!-- ===================================== END HEADER ===================================== -->
	...
	<!-- 
	 ...
	 <div class="col_9">
	 	<h4>Campaign "<?php echo($campaignname) ?>" Created</h3><br/>
	 	<p>Your campaign has been created. Click for <a href="/preview/<?php echo($campaignname) ?>" target="_new">preview.</a></p>
	 </div>
