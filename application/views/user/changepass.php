<!DOCTYPE html>
<html><head>
<title>Flexmailer | Change Password</title>
<meta charset="UTF-8">
...
<!-- ===================================== END HEADER ===================================== -->
	...
	<!-- 
	 ...
	 <ul class="breadcrumbs alt1">
	 	...
	 	<li><a href="/user/changepass/<?php echo ($id); ?>">Change Password</a></li>
	 </ul>
	 </div>
	 <div class="col_9">
	 	<h4>Change Password</h3><br/>
	 	<div class="col_5">	
	 			<?php
	 				if ($formerror) {
					...
					if ($formsuccess) {
	 					...
	 					echo Form::open('/user/changepass/'.$id, 'POST');
						echo Form::label('password', 'New Password');
	 					echo Form::password('password');
						echo ('<br />');
						echo Form::button('Change Password', array('class' => 'small green', 'type' => 'submit'));
						echo Form::close();
